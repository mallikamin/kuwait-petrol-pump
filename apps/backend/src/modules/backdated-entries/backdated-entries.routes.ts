...
// GET /api/backdated-entries/daily/reconciliation-range - Fast range summary for reconciliation dashboard
router.get('/daily/reconciliation-range', dailyController.getDailyReconciliationRange);
